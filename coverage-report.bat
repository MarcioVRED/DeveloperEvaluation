...
dotnet restore Ambev.DeveloperStore.sln
dotnet build Ambev.DeveloperStore.sln --configuration Release --no-restore

REM Run tests with coverage
dotnet test Ambev.DeveloperStore.sln --no-restore --verbosity normal ^
